...
class MobileNetV3Cifar(nn.Module):
    def __init__(self, model_mode="large", num_classes=1000, multiplier=1.0, dropout_rate=0.2):
        ...
        for kernel_size, exp_size, out_channels_num, use_SE, NL, stride in layers:
            ...
            self.block.append(MobileBlockCifar(init_conv_out, output_channels_num, kernel_size, stride, NL, use_SE, exp_size))
...
# model = MobileNetV3Cifar(model_mode="LARGE", num_classes=1000, multiplier=1.0)

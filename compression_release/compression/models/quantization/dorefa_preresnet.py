...
__all__ = ["DoReFaPreResNet", "DoReFaPreBasicBlock"]
...
class DoReFaPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DoReFaPreBasicBlock, self).__init__()
...
class DoReFaPreResNet(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DoReFaPreResNet, self).__init__()

...
__all__ = ["SuperCompressedJointGatePreResNet", "SuperCompressedJointGatePreBasicBlock"]
...
class SuperCompressedJointGatePreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperCompressedJointGatePreBasicBlock, self).__init__()
        self.name = block_type
        self.downsample = downsample
        # self.num_choices = num_choices
        # self.group_size = out_plane // self.num_choices
        self.group_size = group_size
        self.num_choices = out_plane // self.group_size
        # self.group_size = 4
...
class SuperCompressedJointGatePreResNet(nn.Module):
    """
    define SuperPreResNet on small data sets
    """

    def __init__(
        self, depth, wide_factor=1, num_classes=10, group_size=8
    ):
        """
        ...
        """
        super(SuperCompressedJointGatePreResNet, self).__init__()
        ...
        self.layer1 = self._make_layer(
            SuperCompressedJointGatePreBasicBlock,
            16 * wide_factor,
            n,
    ...
    def _make_layer(
        self, block, out_plane, n_blocks, stride=1, group_size=8,
    ):
        """

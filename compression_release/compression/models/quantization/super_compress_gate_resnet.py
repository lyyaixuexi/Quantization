...
class SuperCompressedGateBasicBlock(nn.Module):
    expansion = 1
    ...
    def __init__(
        ...
        super(SuperCompressedGateBasicBlock, self).__init__()
...
class SuperCompressedGateBottleneck(nn.Module):
    expansion = 4
    ...
    def __init__(
        ...
        super(SuperCompressedGateBottleneck, self).__init__()
...
class SuperCompressedGateResNet(nn.Module):
    def __init__(
        self,
        depth,
        num_classes=1000,
        ...
        self.inplanes = 64
        super(SuperCompressedGateResNet, self).__init__()
        if depth < 50:
            block = SuperCompressedGateBasicBlock
        else:
            block = SuperCompressedGateBottleneck

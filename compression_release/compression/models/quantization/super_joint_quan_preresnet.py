...
__all__ = ["SuperJointQuanPreResNet", "SuperJointQuanPreBasicBlock"]
...
class SuperJointQuanPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperJointQuanPreBasicBlock, self).__init__()
...
class SuperJointQuanPreResNet(nn.Module):
    """
    define SuperJointQuanPreResNet on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(SuperJointQuanPreResNet, self).__init__()

        self.in_plane = 16 * wide_factor
        self.depth = depth
        n = (depth - 2) / 6
        self.conv = qconv3x3(3, 16 * wide_factor, bits_weights=8, bits_activations=32)
        # self.conv = superqconv3x3(3, 16 * wide_factor)
        self.layer1 = self._make_layer(
            SuperJointQuanPreBasicBlock,
            16 * wide_factor,
            n,
        )

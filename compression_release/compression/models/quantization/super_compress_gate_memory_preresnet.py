...
__all__ = ["SuperCompressedGatePreResNetMemory", "SuperCompressedGatePreBasicBlockMemory"]
...
class SuperCompressedGatePreBasicBlockMemory(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperCompressedGatePreBasicBlockMemory, self).__init__()
    ...
    def get_downsample_memory_footprint(self):
        ...
        if self.downsample is not None:
            downsample_activation_memory_footprint = compute_memory_footprint(1, self.downsample.c, self.downsample.h, self.downsample.w)
    ...
    def get_total_memory_footprint(self):
        conv1_activation_memory_footprint = compute_memory_footprint(1, self.conv1.c, self.conv1.h, self.conv1.w)
        ...
        conv2_activation_memory_footprint = compute_memory_footprint(1, self.conv2.c, self.conv2.h, self.conv2.w)
        ...
        if self.downsample:
            ...
            downsample_weight_memory_footprint = compute_memory_footprint(self.downsample.weight.shape[0], self.downsample.weight.shape[1], self.downsample.weight.shape[2], self.downsample.weight.shape[3])
            downsample_memory_footprint = downsample_activation_memory_footprint + downsample_weight_memory_footprint
            print("Layer: {}.{}, Weight: {}, Activation: {}".format(self.layer_name, "downsample", downsample_weight_memory_footprint, downsample_activation_memory_footprint))
        total_memory_footprint = conv1_memory_footprint + conv2_memory_footprint + downsample_memory_footprint
        return total_memory_footprint
...
class SuperCompressedGatePreResNetMemory(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperCompressedGatePreResNetMemory, self).__init__()
        ...
        self.layer1 = self._make_layer(
            SuperCompressedGatePreBasicBlockMemory,
            16 * wide_factor,
            n,

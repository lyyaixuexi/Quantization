...
__all__ = ["SuperQuanPreResNet", "SuperQuanPreBasicBlock"]
...
def superqweightconv3x3(in_planes, out_planes, stride=1, bits_weights_list=[2, 4, 8]):
    "3x3 quantized convolution with padding"
...
class SuperQuanPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperQuanPreBasicBlock, self).__init__()
...
class SuperQuanPreResNet(nn.Module):
    """
    define SuperQuanPreResNet on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(SuperQuanPreResNet, self).__init__()

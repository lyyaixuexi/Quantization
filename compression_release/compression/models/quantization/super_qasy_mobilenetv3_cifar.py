...
class SuperQAsyMobileBlockCifar(nn.Module):
    def __init__(self, in_channels, out_channels, kernal_size, stride, nonLinear, SE, exp_size):
        super(SuperQAsyMobileBlockCifar, self).__init__()
...
class SuperQAsyMobileNetV3Cifar(nn.Module):
    def __init__(self, model_mode="large", num_classes=1000, multiplier=1.0, dropout_rate=0.2, bits_weights=32, bits_activations=32, quantize_first_last=False):
        super(SuperQAsyMobileNetV3Cifar, self).__init__()
        ...
        for kernel_size, exp_size, out_channels_num, use_SE, NL, stride in layers:
            ...
            self.block.append(SuperQAsyMobileBlockCifar(init_conv_out, output_channels_num, kernel_size, stride, NL, use_SE, exp_size))
...
# model = SuperQAsyMobileNetV3Cifar(model_mode="LARGE", num_classes=1000, multiplier=1.0)

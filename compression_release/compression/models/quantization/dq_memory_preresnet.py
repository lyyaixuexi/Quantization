...
from compression.models.quantization.dq_conv_memory import DQConv2d
from compression.models.quantization.dorefa_clip import QConv2d, QLinear

__all__ = ["DQPreResNetMemory", "DQPreBasicBlockMemory"]
...
class DQPreBasicBlockMemory(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DQPreBasicBlockMemory, self).__init__()
...
class DQPreResNetMemory(nn.Module):
    """
    define DQPreResNetMemory on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(DQPreResNetMemory, self).__init__()

...
class SuperQuanMobileNetV1(nn.Module):
    """
    MobileNetV1 on ImageNet
    """

    def __init__(
        self, num_classes=1000, wide_scale=1.0, quantize_first_last=False
    ):
        super(SuperQuanMobileNetV1, self).__init__()

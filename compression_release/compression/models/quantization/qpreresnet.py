...
# from compression.models.quantization.dorefa_wn import QConv2d, QLinear
...
# from compression.models.quantization.dorefa_tet import QConv2d
# from compression.models.quantization.dorefa_wtet import QConv2d
...
# from compression.models.quantization.lsq import QConv2d, QLinear
# from compression.models.quantization.lsq_2 import QConv2d, QLinear
...
class QPreResNet(nn.Module):
    ...
    def __init__(
        self, depth, quantize_first_last=False, wide_factor=1, num_classes=10, bits_weights=32, bits_activations=32
    ):
        """
    ...
    def _make_layer(
        self, block, out_plane, n_blocks, stride=1, bits_weights=32, bits_activations=32
    ):
        """

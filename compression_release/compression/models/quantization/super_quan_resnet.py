...
class SuperQuanBasicBlock(nn.Module):
    expansion = 1
    ...
    def __init__(
        ...
        super(SuperQuanBasicBlock, self).__init__()
...
class SuperQuanBottleneck(nn.Module):
    expansion = 4
    ...
    def __init__(
        ...
        super(SuperQuanBottleneck, self).__init__()
...
class SuperQuanResNet(nn.Module):
    def __init__(
        self,
        depth,
        num_classes=1000,
        ...
        self.inplanes = 64
        super(SuperQuanResNet, self).__init__()
        if depth < 50:
            block = SuperQuanBasicBlock
        else:
            block = SuperQuanBottleneck

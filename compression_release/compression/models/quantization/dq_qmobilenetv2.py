...
__all__ = ["DQMobileNetV2", "DQMobileBottleneck"]
...
class DQMobileBottleneck(nn.Module):
    def __init__(
        self,
        in_planes,
        out_planes,
        ...
        super(DQMobileBottleneck, self).__init__()
...
class DQMobileNetV2(nn.Module):
    """
    MobileNet_v2
    """

    def __init__(self, num_classes=1000, wide_scale=1.0, quantize_first_last=False):
        super(DQMobileNetV2, self).__init__()

        block = DQMobileBottleneck

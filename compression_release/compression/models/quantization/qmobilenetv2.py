...
class QMobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=1000, wide_scale=1.0, bits_weights=32, bits_activations=32, quantize_first_last=False):
        ...
        self.relu1 = nn.ReLU6(inplace=True)
        self.layer1 = self._make_layer(block, self.layer_width[1].item(), blocks=1, bits_weights=bits_weights, bits_activations=bits_activations)

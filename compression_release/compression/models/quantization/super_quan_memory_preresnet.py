...
__all__ = ["SuperQuanPreResNetMemory", "SuperQuanPreBasicBlockMemory"]
...
class SuperQuanPreBasicBlockMemory(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(SuperQuanPreBasicBlockMemory, self).__init__()
...
class SuperQuanPreResNetMemory(nn.Module):
    """
    define SuperQuanPreResNetMemory on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(SuperQuanPreResNetMemory, self).__init__()

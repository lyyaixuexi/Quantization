...
__all__ = ["SuperQuanMobileNetV2", "SuperQuanMobileBottleneck"]
...
def superqconv3x3(in_planes, out_planes, stride=1):
    "3x3 convolution with padding"
    return SuperQConv2d(
        in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False, bits_weights_list=[2, 4, 8], bits_activations_list=[2, 4, 8]
    )
...
def superqconv1x1(in_planes, out_planes):
    "1x1 convolution"
    return SuperQConv2d(in_planes, out_planes, kernel_size=1, bias=False, bits_weights_list=[2, 4, 8], bits_activations_list=[2, 4, 8])
...
class SuperQuanMobileBottleneck(nn.Module):
    def __init__(
        self,
        in_planes,
        out_planes,
        ...
        super(SuperQuanMobileBottleneck, self).__init__()
...
class SuperQuanMobileNetV2(nn.Module):
    """
    MobileNet_v2
    """

    def __init__(self, num_classes=1000, wide_scale=1.0, quantize_first_last=False):
        super(SuperQuanMobileNetV2, self).__init__()

        block = SuperQuanMobileBottleneck

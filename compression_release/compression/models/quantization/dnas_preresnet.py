...
class DNASPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DNASPreBasicBlock, self).__init__()
    ...
    def extra_repr(self):
        s = super().extra_repr()
        s += ", method={}".format("DNASPreBasicBlock")
        return s


class DNASPreResNet(nn.Module):
    """
    ...
    def __init__(self, depth, wide_factor=1, num_classes=10):
        ...
        """
        super(DNASPreResNet, self).__init__()
        ...
        self.layer1 = self._make_layer(
            DNASPreBasicBlock, 16 * wide_factor, n,
        )
        self.layer2 = self._make_layer(
            DNASPreBasicBlock, 32 * wide_factor, n, stride=2,
        )
        self.layer3 = self._make_layer(
            DNASPreBasicBlock, 64 * wide_factor, n, stride=2,
        )

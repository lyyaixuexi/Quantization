...
__all__ = ["DQPreResNet", "DQPreBasicBlock"]
...
class DQPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DQPreBasicBlock, self).__init__()
...
class DQPreResNet(nn.Module):
    """
    define DQPreResNet on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(DQPreResNet, self).__init__()

...
# from compression.models.quantization.dorefa_non_uniform_fast_sigmoid_unbalanced import (
    # QConv2d,
# )
...
# from compression.models.quantization.dorefa_tet_wn_nonuniform import QConv2d
# from compression.models.quantization.dorefa_tet_wn_nonuniform_2 import QConv2d
...
class NonUniformQResNet(nn.Module):
    def __init__(
        self, depth, num_classes=1000, bits_weights=32, bits_activations=32, T=1
    ):
        self.inplanes = 64
        super(NonUniformQResNet, self).__init__()
        if depth < 50:
            block = QBasicBlock
        else:
            block = QBottleneck
    ...
    def _make_layer(
        self, block, planes, blocks, stride=1, bits_weights=32, bits_activations=32, T=1
    ):
        downsample = None

...
__all__ = ["DNASPreResNet", "DNASPreBasicBlock"]
...
class DNASPreBasicBlockClip(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(DNASPreBasicBlockClip, self).__init__()
    ...
    def extra_repr(self):
        s = super().extra_repr()
        s += ", method={}".format("DNASPreBasicBlockClip")
        return s


class DNASPreResNetClip(nn.Module):
    """
    ...
    def __init__(self, depth, wide_factor=1, num_classes=10):
        ...
        """
        super(DNASPreResNetClip, self).__init__()
        ...
        self.layer1 = self._make_layer(
            DNASPreBasicBlockClip, 16 * wide_factor, n,
        )
        self.layer2 = self._make_layer(
            DNASPreBasicBlockClip, 32 * wide_factor, n, stride=2,
        )
        self.layer3 = self._make_layer(
            DNASPreBasicBlockClip, 64 * wide_factor, n, stride=2,
        )

...
CUDA_VISIBLE_DEVICES=6 python -m awq.entry --model_path /mnt/cephfs/home/lyy/.cache/huggingface/hub/models--facebook--opt-6.7b/snapshots/a45aa65bbeb77c1558bc99bedc6779195462dab0 \
    --tasks wikitext \
    --w_bit 4 --q_group_size 128 \
...
CUDA_VISIBLE_DEVICES=2 python -m awq.test --model_path /mnt/cephfs/home/lyy/.cache/huggingface/hub/models--facebook--opt-6.7b/snapshots/a45aa65bbeb77c1558bc99bedc6779195462dab0 \
    --tasks wikitext \
    --w_bit 4 --q_group_size 128 \
    --load_quant /mnt/cephfs/home/lyy/Quantization/llm-awq/quant_cache/opt-6.7b-w4-g128-awq.pt \
    --benchmark 100 \

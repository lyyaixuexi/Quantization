...
CUDA_VISIBLE_DEVICES=4 python train_quantize.py --mode train --data ../pcb_3 --config config/res18/retrain-pcb-v3.yaml --flops 1040 --chcfg /mnt/cephfs/home/lyy/Quantization/dmcp/results/DMCPResNet18_1040.0_051312/model_sample/expected_ch --quantization  --quantization_bits 32 --m_bits 16 --bias_bits 32 --save_dir './stage1/int32' >out_32bits_stage1.txt


CUDA_VISIBLE_DEVICES=1 python main.py --mode train --data /mnt/cephfs/home/lyy/data/body_detect/split_data  --config config/res18/retrain-pcb-v3.yaml --flops  1040 --chcfg /mnt/cephfs/home/lyy/Quantization/dmcp/results/DMCPResNet18_1040.0_051312/model_sample/expected_ch

...
ssl_train -b 1024 -d 0-7 -e 1000 -f finetuning_rpe_exp.py --amp \
--ckpt /mnt/cephfs/home/lyy/Quantization/MAE-Lite/outputs/mae_lite/mae_tiny_400e_numheads8/last_epoch_ckpt.pth.tar --exp-options pretrain_exp_name=mae_lite/mae_tiny_400e_numheads8 --resume
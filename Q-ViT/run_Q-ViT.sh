...
CUDA_VISIBLE_DEVICES=${GPU_ID} python -m torch.distributed.launch --master_port=12223 --nproc_per_node=8 --use_env main.py \
        ...
        --teacher-model deit_tiny_distilled_patch16_224 \
        --opt fusedlamb \

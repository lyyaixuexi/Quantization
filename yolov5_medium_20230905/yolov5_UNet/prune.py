...
# '''
  ...
  #  print("prune module :",model_list.keys())
   ...
   # print(maskbndict.keys())
    print(remain_num)
    print(total_num)
    print("prune rate: ", ((total_num - remain_num)*1.0) / total_num)

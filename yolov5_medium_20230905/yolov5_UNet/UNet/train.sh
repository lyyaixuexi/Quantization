...
########################################### train quantize model with downscaling & overflow-aware training jointly #########################################################
# int8  100 epoch  lr0.0001   初始化 mpa:48.29 mIou:0.1643   最佳模型 mpa: 88.00  mIoU: 0.5471
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train.py --jointly -l 0.0001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 50 -f -M -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220308_jointly_exp1 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220308_jointly_exp1.txt
# int8  100 epoch  lr0.0001   初始化 mpa:48.29 mIou:0.1643   最佳模型 mpa: 88.19  mIoU: 0.5464
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train.py --jointly -l 0.00001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 50 -f -M -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220308_jointly_exp2 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220308_jointly_exp2.txt
...
########### 约束 n 不大于31后，重新跑了三次stage2 ###########
# 最佳模型 mpa:88.54   mIoU:0.5
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_mixture_bits.py --mixture_16bit_8bit mixture_quant_config.txt -l 0.00001 -e 50 -b 8 --quarter_channel --strict_cin_number -q --OAQ_m 50 -f -M -r q -m ./checkpoint/ckpt_int16_int8_mixture_100epoch_20220222_lr0001_exp3/CP_best_epoch88.pth -c ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp9 2>&1 | tee ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp9.txt
# 最佳模型 mpa:88.56   mIoU:0.5588    约束n最大值后的最佳模型
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_mixture_bits.py --mixture_16bit_8bit mixture_quant_config.txt -l 0.00001 -e 50 -b 8 --quarter_channel --strict_cin_number -q --OAQ_m 50 -f -M -r q -m ./checkpoint/ckpt_int16_int8_mixture_100epoch_20220222_lr0001_exp3/CP_best_epoch88.pth -c ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp10 2>&1 | tee ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp10.txt
# 最佳模型 mpa:88.51   mIoU:0.5568
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_mixture_bits.py --mixture_16bit_8bit mixture_quant_config.txt -l 0.00001 -e 50 -b 8 --quarter_channel --strict_cin_number -q --OAQ_m 50 -f -M -r q -m ./checkpoint/ckpt_int16_int8_mixture_100epoch_20220222_lr0001_exp3/CP_best_epoch88.pth -c ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp11 2>&1 | tee ./checkpoint/ckpt_int16_int8_mixture_50epoch_20220222_stage2_exp11.txt


################################################## eval quantization stage2 ####################################################
#　不约束n小于等于31时，mpa:88.55   mIoU:0.5585
#　约束n小于等于31时，mpa:88.56   mIoU:0.5582
...
# compress original unpruned model
# 16bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int16_original_param.npy
# 8bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int8_original_param.npy
# 4bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int4_original_param.npy

# compress half channel pruned model
# 16bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int16_half_channel_strict_param.npy
# 8bit
...
# 4bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int4_half_channel_strict_param.npy

# compress quarter channel pruned model
# 16bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int16_quarter_channel_strict_param.npy
# 8bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int8_quarter_channel_strict_param.npy
# 4bit
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int4_quarter_channel_strict_param.npy
# 16bit and 8 bit mixture quantization
python convert_parameters_from_fp32_to_int.py --fp32_quantized_param_file data/Unet_output_int16_int8_mixture_quarter_channel_strict_param.npy


########################################### train quantize model stage1, use different kind of overflow aware training to suppress the activation location #########################################################
# int8  100 epoch  lr0.0001  初始化 mpa: 81.02% mIoU: 0.4282   beta:10       mIoU: 0.2421  卷积结果仍存在极少量的溢出情况
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_suppress_act.py -l 0.0001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 10 --beta 10 -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta10 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta10.txt

# int8  100 epoch  lr0.0001  初始化 mpa: 81.02% mIoU: 0.4282   beta:1        mIoU: 0.4005  卷积结果仍存在少量的溢出情况
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_suppress_act.py -l 0.0001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 10 --beta 1 -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta1 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta1.txt

# int8  100 epoch  lr0.0001  初始化 mpa: 81.02% mIoU: 0.4282   beta:0.1      mIoU: 0.5137  卷积结果仍存在严重的溢出情况
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_suppress_act.py -l 0.0001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 10 --beta 0.1 -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta01 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta01.txt

# int8  100 epoch  lr0.0001  初始化 mpa: 81.02% mIoU: 0.4282   beta:0.01     mIoU: 0.5371  卷积结果仍存在严重的溢出情况
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 train_suppress_act.py -l 0.0001 -e 100 -b 8 --quarter_channel --strict_cin_number -q -x 8 -y 12 -z 16 --OAQ_m 10 --beta 0.01 -m ./checkpoint/ckpt_fp32_200epoch_quarter_channel_strict_cin_number_20211102_2gpu/CP_best_epoch187.pth -c ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta001 2>&1 | tee ./checkpoint/ckpt_int8_100epoch_20220811_lr0001_suppress_act_beta001.txt

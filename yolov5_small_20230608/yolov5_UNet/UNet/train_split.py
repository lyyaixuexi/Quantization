...
def get_args():
    ...
    parser.add_argument('--conv_type', type=str, default='split_conv_sum_bn_relu', help="split_conv_sum_bn_relu, split_conv_bn_sum_relu, split_conv_bn_relu_sum")
...
if __name__ == '__main__':
    ...
    # todo
    # replace the conv_bn_relu with split_conv
    if args.channel_each_group != -1:
        net = split_conv_util.replace(net, args.channel_each_group, args.conv_type)
        print("after replace conv_bn_reku with split_conv: {}".format(net))
